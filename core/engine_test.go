...
func TestSessionMismatch_RecyclesStaleAgent(t *testing.T) {
	...
	state := e.getOrCreateInteractiveStateWith(key, key, p, "ctx", session, nil, e.sessions)
...
func TestSessionIDWriteback_ImmediateAfterStartSession(t *testing.T) {
	...
	e.getOrCreateInteractiveStateWith(key, key, p, "ctx", session, nil, e.sessions)
...
func TestStaleGoroutineCleanup_RaceSimulation(t *testing.T) {
	...
	newState := e.getOrCreateInteractiveStateWith(key, key, p, "ctx", sessionB, nil, e.sessions)
